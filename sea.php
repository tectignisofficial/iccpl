...
<head>
  ...
  <!-- Favicons -->
  <link href="assets/img/logohf.webp" rel="icon">
  <link href="assets/img/logohf.webp" rel="apple-touch-icon">
        ...
        <div class="row gy-4">
         ...
         <ul>
          ...
          <div class="col-lg-6 content order-last  order-lg-last">
                <h3>Some of our capabilities include:</h3>
              ...
              <li style="margin-top:10px">
                <i class="fa-solid fa-check-double"></i>
                Delivery to consignee destination of import cargo after custom clearance from aircargo and seaport on our own delivery trucks.
              </li>
              <li style="margin-top:10px">
