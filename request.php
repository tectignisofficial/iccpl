...
$hscode=$_POST['hscode'];
$temperatureRegime=$_POST['temperatureRegime'];
$temperatureDegree=$_POST['temperatureDegree'];
$imoClass=$_POST['imoClass'];
$unNumber=$_POST['unNumber'];
$odcLength=$_POST['odcLength'];
$odcwidth=$_POST['odcwidth'];
$odcheight=$_POST['odcheight'];
$seaTransport=$_POST['seaTransport'];
