        ...
        Add 
            ...
            <tbody>
                        ...
                        ?>
                                    ...
                                    <a href="enquiry.php?delid=<?php echo $arr['id']; ?>"><button type="button" class="btn btn-outline-primary"><i data-feather="trash"></i></button></a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body pb-5 px-sm-5 pt-50">
                                ...
                                <form id="editUserForm" class="row gy-1 pt-75" method="post" >
                                    ...
                                    <div class="col-12 col-md-6">
                                        <label class="form-label" for="modalEditUserLastName">Company Email</label>
                                        <input type="company_email" class="form-control" name="company_email" placeholder="Email">
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="modalEditUserName">Job Title</label>
                                        <input type="text" id="job_title" name="job_title" class="form-control"  placeholder="Job Title" />
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label" for="modalEditUserName">Company</label>
                                    ...
                                    <div class="col-12">
                                        <label class="form-label" for="modalEditUserName">Industry</label>
