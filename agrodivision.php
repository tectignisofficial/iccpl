    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-5">
            <img src="assets1/img/jcb.webp" class="img-fluid" alt="" style="border-radius:2%">
          </div>
          <div class="col-md-7">
          <h3 class="mb-4">About Agro</h3>
            ...
            <p>The Division is also engaged in creating a federated Farmers Database by compiling information of the farmers from various databases available with the Government and linking them with land records. The Division is in the process of entering into MoUs with various leading Agriculture/Technology/Other players in the Country for developing Proof of Concepts (PoCs) on the farmers database. The IDEA Concept has been finalised.</p>
          </div>
        </div><!-- Features Item -->

        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="assets1/img/windmil.webp" class="img-fluid" alt="" style="width:100% ;border-radius:2%"">
          </div>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up" >
          <div class="col-md-5">
            <img src="assets1/img/nature.webp" class="img-fluid" alt="" style="border-radius:2%">
          </div>
          <div class="col-md-7">
