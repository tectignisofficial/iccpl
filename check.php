    ...
    <main id="main">
        ...
        <div class="breadcrumbs">
            <div class="page-header d-flex align-items-center"
                style="background-image: url('assets1/img/page-header.webp');">
            ...
            <div class="section">
                <div class="card">
                    <div class="card-head">
                        ...
                        <form action="formaction.php" class="divform" method="post" name="form1"
                            ...
                            <div class="divformmain mt-4">
                                ...
                                <div class="divformcargomain">
                                    <div class="d-block">
                                        ...
                                        <div class="divformcargohead mt-5"><label class="label" id="lbltext"
                                               >HS Code<span style="color:red">
                                                    *</span></label>
                                        </div>
                                        <div class="divformcargoinput"><span class="divformcargospan divformcargospan1">
                                                <input type="number"
                                                    class="divforminputControl divforminputControl1 form-control"
                                                    name="hscode" placeholder="Enter HS code" id="text1"
                                                    required></span></span>
                                        ...
                                        <div class="weightdiv parent">
                                            <div class="weightdiv1"><input class="divformcontrolInput" id="netWeight"
                                                    type="number" name="hscodenetweight" placeholder="Net Weight"
                                                    required>
                                            </div><span class="mt">
                                                    ...
                                                    <div class="lessContainer">
                                                        ...
                                                        <div class="checkboxconta" id="checkboxconta">
                                                            ...
                                                            <div class="totalship mt-2 mb-3">
                                                                <button type="button" class="add addnewrow"><span
                                                                        style="">+
                                                                        &nbsp;</span>Add</button>
                                                            ...
                                                            <div class="form-group mt-2">
                                                                ...
                                                                <div id="datepicker" class="input-group date"
                                                                    ...
                                                                    <input class="form-control" type="text"
                                                                        placeholder="Select Date" name="pickUpDate"
                                                                        required />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group mt-2">
                                                                ...
                                                                <textarea name="additional" id="" class="form-control"
                                                                    required></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="associatemaindiv">
                                        <div class="assodiv mt-3">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        ...
                                                        name="services[]" value="Insurance"><span
                                                        class="checktext">Insurance</span></span></label>

                                        </div>
                                        <div class="assodiv mt-3 warHous">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        class="checkinput" value="Warehouse" type="checkbox"
                                                        name="services[]"><span
                                                        class="checktext">Warehouse</span></span></label>
                                        </div>
                                        <div class="assodiv mt-3 insSer">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        class="checkinput" value="Inspection Services" type="checkbox"
                                                        name="services[]"><span class="checktext">Inspection
                                                        Services</span></span></label>
                                        </div>
                                        <div class="assodiv mt-3 certificate">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        class="checkinput" type="checkbox" value="Certification"
                                                        name="services[]"><span
                                                        class="checktext">Certification</span></span></label>
                                        </div>
                                        <div class="assodiv mt-3 roadTransportation">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        class="checkinput" type="checkbox" value="Road Transport"
                                                        name="services[]"><span class="checktext">Road
                                                        Transport</span></span></label>
                                        </div>
                                        <div class="assodiv mt-3">
                                            <label class="checklabel mt-2"><span class="checkspan"><input
                                                        class="checkinput" type="checkbox" value="Customs clearance"
                                                        name="services[]"><span class="checktext">Customs
                            ...
                            <div class="divformhead divformwidth">
                                <div class="form-group">
                                    <input type="submit" class="btn btn-outline-warning" name="send" value="Submit"
                                        onclick="stringlength(document.form1.hscode,1,9)" />
                                </div>
                            </div>
                    </div>
                    </form>
