      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="card"  style="border-radius:2%">
              <div class="card-img"  style="border-radius:2%">
                <img src="assets1\img\truck.webp" alt="" class="img-fluid">
              </div>
      ...
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="assets1\img\s1.webp" class="img-fluid" alt="">
          </div>
          <div class="col-md-7 order-2 order-md-1">
            ...
            <p>
            With a supply chain services expert like Us on your side, you'll soon find out.
            </p>
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5">
            <img src="assets1\img\s4.webp" class="img-fluid" alt="">
          </div>
          <div class="col-md-7">
