...
<head>
  ...
  <title>Project & Construction Division</title>
        ...
        <div class="container position-relative">
          <div class="row d-flex justify-content-center">
            <div class="col-lg-6 text-center">
              <h2>Project And Construction Division</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <section id="features" class="features">
      <div class="container">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          ...
          <div class="col-md-5">
            <img src="assets1/img/pro1.webp" class="img-fluid" alt="" style="width:100%; border-radius:2%">
          </div>
          <div class="col-md-7">
        ...
        <div class="row gy-4 align-items-center features-item" data-aos="fade-up">
          <div class="col-md-5 order-1 order-md-2">
            <img src="assets1/img/pro2.webp" class="img-fluid" alt="" style="width:100%; border-radius:2%">
          </div>
          <div class="col-md-7 order-2 order-md-1">
            ...
            <ul>
              <li><i class="bi bi-check"></i> Will it yield a positive ROI?</li>
              <li><i class="bi bi-check"></i> Are the associated risks manageable?</li>
              <li><i class="bi bi-check"></i>Does it fit into your company’s portfolio?</li>
            </ul>
