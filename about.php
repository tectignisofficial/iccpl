  ...
  <main id="main">
      ...
      <div class="container" data-aos="fade-up">
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-last order-last">
            ...
            As a responsible and employee friendly organisation, we ensure workplace safety of our employees and it is of our prime importance to us to continuously harness to adopt best safety systems. Our people our assets1 and their welfare is our responsibility. We respect and encourage talent and in our endeavour to bring out the best in our employees, we adopt policies that are formulated to meet their needs</p>
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-first order-first">
            <img src="assets1\img\counts-img.svg" class="img-fluid" alt="">
          </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-6 position-relative align-self-start order-lg-last order-first">
            <img src="assets1\img\ab4.webp" class="img-fluid" alt="">
          </div>
    ...
    <!-- <section class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 position-relative align-self-start order-lg-first order-first">
            <img src="assets1\img\ab.webp" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 content order-last  order-lg-last">
